...
export class Player extends Schema {
  ...
  canLaunch(): boolean {
    ...
    const hasFuselage = this.rocketComponents.some(c => c.name.includes("Fuselage"));
    const hasNoseCone = this.rocketComponents.some(c => c.name.includes("Nose Cone"));
    const hasFins = this.rocketComponents.some(c => c.name.includes("Stabilizer Fins"));
    const hasThruster = this.rocketComponents.some(c => c.name.includes("Thruster"));
