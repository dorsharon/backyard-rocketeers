...
export class HostileTakeoverCard extends SabotageCard {
  ...
  readonly description = "It's not personal, it's just business. Well... maybe a little personal.";
  ...
  apply(gameState: GameState, player: Player, targetPlayerId?: string): void {
    ...
    const covertCardIndex = target.rocketComponents.findIndex(c => c.isCovert && !c.isRevealed);
